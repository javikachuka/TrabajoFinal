...
<head>
	...
	<link rel="shortcut icon" href="{{asset('admin_panel/plugins/fontawesome-free/css/all.min.css')}}">
...
<body>
	...
	<div id="header">
		<table>
			<tr>
				...
				<td style="text-align: center;font-size: 25px;color: #000;">Cooperativa de Agua Potable</td>
				@if ($datos!="")
			...
			<tr>
				<td colspan="3" style="text-align: center;color: #000;">San Jose - Misiones</td>
			</tr>
		</table>
	</div>
	...
	<div id="gris" >
		...
		<div class="infor">
			<p>Dirección: Av. 9 de Julio
			 <br> Email: coopAguaPot@gmail.com
			  <br>Teléfono: 3764293656</p>
		</div>
	</div>
