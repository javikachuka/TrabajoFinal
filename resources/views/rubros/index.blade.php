...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
           ...
           <h3>Listado de Rubros <span></span> <a href=""  class="btn btn-primary btn-xs " data-toggle="modal" data-target="#crear">Nuevo Rubro</a></h3>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td width ="150px">
                                ...
                                @can('rubros_edit')
                                    ...
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="editar{{$rubro->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <div class="form-group">
                                                            <label>Nombre</label>
                                                            <input type="text" name="nombre" required value="{{ $rubro->nombre ?? old('nombre')}}"  class="form-control">
                                                    </div>
                                                </div>
                                ...
                                @endcan
                            <form method="POST" action="rubros/{{$rubro->id}}" onsubmit="return confirm('Desea borrar {{$rubro->nombre}}')" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
