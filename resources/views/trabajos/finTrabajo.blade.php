...
<form class="form-group " method="POST" action="{{route('trabajos.guardarFinalizacion', $trabajo)}}" enctype="multipart/form-data">
@method('PUT')
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-md-5">
                    ...
                    <input class="custom-file" type="file" name="fotoFin" accept="image/*" capture="camera"  style="" required/>
            ...
            <div class="row d-flex justify-content-around py-3">
                ...
                <div class="form-group my-5">
                        ...
                        <select name="empleados[]" id="empleados" class="empleados-js form-control" multiple="multiple" required>
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}">{{$empleado->name}} {{$empleado->apellido}} {{$empleado->dni}}</option>
                            @endforeach
                        </select>
                </div>
                <div class="form-group my-5">
