                ...
                <form class="form-group " method="POST" action="/flujoTrabajos/{{$flujoTrabajo->id}}">
                    ...
                    <table id="users" class="table table-sm table-bordered table-striped table-hover datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="hidden" name="nombre[]" value="{{$tran->nombre}}">{{$tran->nombre}}
                                </td>
                                <td><input type="hidden" name="estadoInicial_id[]"
                                        value="{{$tran->estadoInicial->id}}">{{$tran->estadoInicial->nombre}}</td>
                                <td><input type="hidden" name="estadoFinal_id[]"
                                        value="{{$tran->estadoFinal->id}}">{{$tran->estadoFinal->nombre}}</td>
                                <td>
                                    <a href="#" class="up"><i class="fas fa-caret-up"></i></a> <a href="#"
                                        class="down"><i class="fas fa-caret-down"></i></a></td>
                                <td width="75px"><a href="#" class="btn btn-danger btn-xs remove"><i
